...
export function renderLearningActivityEditorView() {
    ...
    const deleteButtonHtml = draft.isNew ? '' : `
        <button
            ...
            data-learning-activity-id="${draft.id}"
            class="px-4 py-2 rounded-md border border-red-200 dark:border-red-700 text-red-700 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/30 flex items-center gap-2"
        >
